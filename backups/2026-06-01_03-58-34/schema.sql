...
CREATE OR REPLACE FUNCTION "public"."handle_new_user"() RETURNS "trigger"
    ...
    AS $$
BEGIN
  -- 1. Create/Sync profile on insert
  ...
  -- 2. Reconciliation: Only run if the user has just been confirmed
  -- This checks if the user moved from 'not confirmed' to 'confirmed'
