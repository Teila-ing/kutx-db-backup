...
ALTER TABLE ONLY "public"."v2_projets_themes"
    ADD CONSTRAINT "v2_projets_themes_pkey" PRIMARY KEY ("projet_id", "theme_id", "cible");
...
CREATE INDEX "projets_phases_projet_id_idx" ON "public"."projets_phases" USING "btree" ("projet_id");



CREATE INDEX "v2_releves_projet_id_idx" ON "public"."v2_releves" USING "btree" ("projet_id");



CREATE OR REPLACE TRIGGER "on_project_created" AFTER INSERT ON "public"."projets" FOR EACH ROW EXECUTE FUNCTION "public"."handle_new_project"();
...
ALTER TABLE ONLY "public"."doc_to_review"
    ADD CONSTRAINT "doc_to_review_projet_id_fkey" FOREIGN KEY ("projet_id") REFERENCES "public"."projets"("id") ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."project_members"
    ADD CONSTRAINT "project_members_project_id_fkey" FOREIGN KEY ("project_id") REFERENCES "public"."projets"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."v2_projets_themes"
    ADD CONSTRAINT "v2_projets_themes_theme_id_fkey" FOREIGN KEY ("theme_id") REFERENCES "public"."v2_themes"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."v2_themes"
    ADD CONSTRAINT "v2_themes_projet_id_fkey" FOREIGN KEY ("projet_id") REFERENCES "public"."projets"("id") ON DELETE CASCADE;
...
CREATE POLICY "Enable del access for all users" ON "public"."projets_phases" FOR DELETE TO "authenticated" USING (true);
...
CREATE POLICY "Enable del access for all users" ON "public"."v2_projets_themes" FOR DELETE TO "authenticated" USING (true);
...
CREATE POLICY "Enable insert for authenticated users only" ON "public"."v2_projets_themes" FOR INSERT TO "authenticated" WITH CHECK (true);
...
CREATE POLICY "Enable update access for all users" ON "public"."projets_phases" FOR UPDATE TO "authenticated" USING (true) WITH CHECK (true);
...
CREATE POLICY "Projects - Create for kutx_creator or kutx_super_admin" ON "public"."projets" FOR INSERT TO "authenticated" WITH CHECK ((( SELECT "public"."get_my_platform_role"() AS "get_my_platform_role") = ANY (ARRAY['kutx_creator'::"text", 'kutx_super_admin'::"text"])));



CREATE POLICY "Projects - Read my projects or kutx_super_admin" ON "public"."projets" FOR SELECT TO "authenticated" USING (((( SELECT "public"."get_my_platform_role"() AS "get_my_platform_role") = 'kutx_super_admin'::"text") OR (( SELECT "public"."get_my_project_role"("projets"."id") AS "get_my_project_role") IS NOT NULL)));



CREATE POLICY "Projects - Update/Delete by project_admin or kutx_super_admin" ON "public"."projets" TO "authenticated" USING (((( SELECT "public"."get_my_platform_role"() AS "get_my_platform_role") = 'kutx_super_admin'::"text") OR (( SELECT "public"."get_my_project_role"("projets"."id") AS "get_my_project_role") = 'project_admin'::"text")));
...
CREATE POLICY "projet_utilisateurs update informations_batiments" ON "public"."informations_batiment" FOR UPDATE TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM ("public"."project_members" "pm"
     JOIN "public"."batiments" "b" ON (("b"."projet_id" = "pm"."project_id")))
