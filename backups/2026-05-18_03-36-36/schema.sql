...
CREATE POLICY "Enable delete access for all users" ON "public"."v2_themes" FOR DELETE TO "authenticated" USING (true);
...
CREATE POLICY "Enable update access for all users" ON "public"."v2_themes" FOR UPDATE TO "authenticated" USING (true) WITH CHECK (true);
