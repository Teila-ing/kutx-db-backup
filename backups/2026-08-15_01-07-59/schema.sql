...
CREATE TABLE IF NOT EXISTS "public"."project_themes_batiments" (
    "project_id" "uuid" NOT NULL,
    "theme_id" "uuid" NOT NULL
);


ALTER TABLE "public"."project_themes_batiments" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."project_themes_sites" (
    "project_id" "uuid" NOT NULL,
    "theme_id" "uuid" NOT NULL
);


ALTER TABLE "public"."project_themes_sites" OWNER TO "postgres";
...
ALTER TABLE ONLY "public"."project_themes_batiments"
    ADD CONSTRAINT "project_themes_batiments_pkey" PRIMARY KEY ("project_id", "theme_id");



ALTER TABLE ONLY "public"."project_themes_sites"
    ADD CONSTRAINT "project_themes_sites_pkey" PRIMARY KEY ("project_id", "theme_id");
...
CREATE INDEX "commentaires_formulaire_batiment_id_idx" ON "public"."commentaires" USING "btree" ("formulaire_batiment_id");
...
CREATE INDEX "idx_notif_user_project" ON "public"."notifications" USING "btree" ("user_id", "project_id", "is_read", "created_at" DESC);
...
CREATE INDEX "information_photos_informations_batiment_id_idx" ON "public"."information_photos" USING "btree" ("informations_batiment_id");



CREATE INDEX "informations_batiment_batiment_id_idx" ON "public"."informations_batiment" USING "btree" ("batiment_id");
...
ALTER TABLE ONLY "public"."project_themes_batiments"
    ADD CONSTRAINT "project_themes_batiments_project_id_fkey" FOREIGN KEY ("project_id") REFERENCES "public"."projects"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."project_themes_batiments"
    ADD CONSTRAINT "project_themes_batiments_theme_id_fkey" FOREIGN KEY ("theme_id") REFERENCES "public"."themes_batiment"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."project_themes_sites"
    ADD CONSTRAINT "project_themes_sites_project_id_fkey" FOREIGN KEY ("project_id") REFERENCES "public"."projects"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."project_themes_sites"
    ADD CONSTRAINT "project_themes_sites_theme_id_fkey" FOREIGN KEY ("theme_id") REFERENCES "public"."themes_site"("id") ON DELETE CASCADE;
...
CREATE POLICY "Enable del for authenticated users only" ON "public"."project_themes_batiments" FOR DELETE TO "authenticated" USING (true);



CREATE POLICY "Enable del for authenticated users only" ON "public"."project_themes_sites" FOR DELETE TO "authenticated" USING (true);
...
CREATE POLICY "Enable insert for authenticated users only" ON "public"."project_themes_batiments" FOR INSERT TO "authenticated" WITH CHECK (true);



CREATE POLICY "Enable insert for authenticated users only" ON "public"."project_themes_sites" FOR INSERT TO "authenticated" WITH CHECK (true);
...
CREATE POLICY "Enable read access for all users" ON "public"."project_themes_batiments" FOR SELECT USING (true);



CREATE POLICY "Enable read access for all users" ON "public"."project_themes_sites" FOR SELECT USING (true);
...
CASE
    WHEN ("informations_site_id" IS NOT NULL) THEN (EXISTS ( SELECT 1
      ...
      WHERE (("is2"."id" = "information_photos"."informations_site_id") AND ("pm"."user_id" = "auth"."uid"()))))
    WHEN ("informations_batiment_id" IS NOT NULL) THEN (EXISTS ( SELECT 1
       FROM (((("public"."informations_batiment" "ib"
         ...
         JOIN "public"."projects" "p" ON (("s"."project_id" = "p"."id")))
         JOIN "public"."project_members" "pm" ON (("p"."id" = "pm"."project_id")))
      WHERE (("ib"."id" = "information_photos"."informations_batiment_id") AND ("pm"."user_id" = "auth"."uid"()))))
    ELSE false
END);
...
CREATE POLICY "project_members update informations_batiments" ON "public"."informations_batiment" FOR UPDATE TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM ("public"."project_members" "pm"
     JOIN "public"."batiments" "b" ON (("b"."project_id" = "pm"."project_id")))
  WHERE (("pm"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("b"."id" = "informations_batiment"."batiment_id"))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM ("public"."project_members" "pm"
     JOIN "public"."batiments" "b" ON (("b"."project_id" = "pm"."project_id")))
  WHERE (("pm"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("b"."id" = "informations_batiment"."batiment_id")))));
...
ALTER TABLE "public"."project_themes_batiments" ENABLE ROW LEVEL SECURITY;


ALTER TABLE "public"."project_themes_sites" ENABLE ROW LEVEL SECURITY;
...
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE "public"."project_themes_batiments" TO "anon";
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE "public"."project_themes_batiments" TO "authenticated";
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE "public"."project_themes_batiments" TO "service_role";



GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE "public"."project_themes_sites" TO "anon";
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE "public"."project_themes_sites" TO "authenticated";
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE "public"."project_themes_sites" TO "service_role";
