...
CREATE OR REPLACE FUNCTION "public"."handle_new_user"() RETURNS "trigger"
  ...
  job_role)                                                                     
      ...
      -- Automatic reconciliation: link pending invitations to the new user ID  
...
CREATE TABLE IF NOT EXISTS "public"."project_members" (
    ...
    "role" "text",
    "project_role" "text" DEFAULT ''::"text"
);
...
GRANT REFERENCES,TRIGGER,TRUNCATE ON TABLE "public"."v2_projets_themes" TO "service_role";
...
GRANT REFERENCES,TRIGGER,TRUNCATE ON TABLE "public"."v2_themes" TO "service_role";
