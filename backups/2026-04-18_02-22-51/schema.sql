...
CREATE TABLE IF NOT EXISTS "public"."projets_phases" (
    ...
    "nom" "text" NOT NULL,
    "description" "text",
    "route_custom" "text" DEFAULT ''::"text" NOT NULL,
    "statut" "text" DEFAULT 'a_faire'::"text" NOT NULL,
    CONSTRAINT "projets_phases_statut_check" CHECK (("statut" = ANY (ARRAY['a_faire'::"text", 'en_cours'::"text", 'terminee'::"text"])))
);
...
ALTER TABLE ONLY "public"."v2_projets_themes"
    ADD CONSTRAINT "v2_projets_themes_pkey" PRIMARY KEY ("projet_id", "theme_id");
...
ALTER TABLE ONLY "public"."v2_releves"
    ADD CONSTRAINT "v2_releves_theme_id_fkey" FOREIGN KEY ("theme_id") REFERENCES "public"."v2_themes"("id");
...
CREATE POLICY "Enable update access for all users" ON "public"."v2_releves" FOR UPDATE TO "authenticated" USING (true) WITH CHECK (("auth"."uid"() = "auteur_id"));
